...
| [A1 Psychology](skills/a1-psy/)<br>`a1-psy` | Diagnose choice, attention, belief, processing, or experience hypotheses behind a marketing outcome, then design a truthful test. |
...
- Need an evidence-bounded explanation of a choice, attention, belief, processing, or experience outcome? Use **A1 Psychology**.
...
**What it does:** diagnoses a choice, attention, belief, processing, or experience outcome through a small set of testable psychological hypotheses. It separates what was observed from what caused it, makes uncertainty explicit, and designs a truthful, reversible experiment with countermetrics.

**Use it when:** you want to understand a behavioral mechanism behind plan choice, familiarity, evidence selection, novice comprehension, an affective judgment, or remembered experience. It analyzes only its supported models; it does not investigate traffic, analytics, attribution, technical failures, or unrelated psychological mechanisms.
...
The current release covers choice architecture; mere exposure and availability; confirmation bias and processing fluency; affect heuristic, peak–end, and curse of knowledge. It warns when a proposed intervention is deceptive or otherwise risky, then helps test a transparent alternative.
