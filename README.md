...
| [A1 Psychology](skills/a1-psy/)<br>`a1-psy` | Diagnose bounded choice-architecture or pricing/valuation hypotheses behind a marketing choice or related metric change, then design a truthful test. |
...
- Need an evidence-bounded explanation of a choice-architecture or pricing/valuation change or related metric? Use **A1 Psychology**.
...
**What it does:** diagnoses a choice-architecture, pricing, or valuation change—or a related marketing metric—through a small set of testable psychological hypotheses. It separates what was observed from what caused it, makes uncertainty explicit, and designs a truthful, reversible experiment with countermetrics.

**Use it when:** you want to understand a behavioral mechanism behind plan choice, an option comparison, a default, a credible price reference, payment experience, or a related conversion change. It analyzes only the supported choice-architecture and pricing/valuation hypotheses; it does not investigate traffic, analytics, attribution, technical failures, or unrelated psychological mechanisms.
...
It covers choice architecture plus a bounded pricing/valuation set: endowment, present bias/temporal discounting, mental accounting, reference price, pain of paying, zero-price, left-digit, and price–quality inference. It warns about deceptive pricing, hidden fees, false comparators, or coercive payment pressure and helps test a transparent alternative. A price, payment method, or revenue change alone never proves a model or guarantees revenue.
