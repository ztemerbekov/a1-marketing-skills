...
6. **[A1 Article Writing](./docs/skills/a1-article-writing.md)** (`/a1-article-writing`) turns a topic, supplied material, or verified research into a new article, guide, case study, or newsletter issue.
7. **[A1 Decision Memo](./docs/skills/a1-decision-memo.md)** (`/a1-decision-memo`) organizes complex supplied material into an internal memo for a specific decision-maker.
8. **[A1 Promo Page](./docs/skills/a1-promo-page.md)** (`/a1-promo-page`) creates the architecture or copy for one evidence-led promotional page, audience, and action.
9. **[A1 Press Release](./docs/skills/a1-press-release.md)** (`/a1-press-release`) drafts routine media announcements and labels them as working or distribution-ready while keeping high-risk communications out of scope.
10. **[Humanize](./docs/skills/a1-humanize.md)** (`/a1-humanize`) removes recognizable AI-writing patterns while preserving the author's natural rhythm, voice, and specific details.
...
> `[paste your draft]`
>
> **Result:** Clean, finished copy in the brand’s Tone of Voice without fluff or AI clichés, with the source facts and useful detail preserved.
...
<details>
<summary><strong>A1 Article Writing — turn source material into useful long-form writing</strong></summary>

<br>

A1 Article Writing creates a new article, guide, case study, expert essay, or newsletter issue from a topic, supplied notes, interviews, source packs, or verified research. It can return either an evidence-aware outline or a finished draft, choosing the structure from the reader's job and the material instead of forcing one universal formula.

It preserves quotations, qualifications, and source boundaries; unsupported claims appear as evidence gaps rather than finished prose. Editing a selected finished draft remains a job for A1 Copy Editing.

**Try:**

> `/a1-article-writing`
>
> Turn these interview notes and product data into a practical article for operations leaders. Show any evidence gaps separately.

Read the [A1 Article Writing guide](./docs/skills/a1-article-writing.md).

</details>

<details>
<summary><strong>A1 Decision Memo — make complex inputs decision-ready</strong></summary>

<br>

A1 Decision Memo turns reports, analysis, correspondence, meeting material, or a chronology into one internal document for a specific decision-maker. It leads with the situation and the decision, response, or awareness state, then layers the evidence, options, risks, owners, and deadlines that the sources actually support.

It can consume specialist analysis but does not perform or replace that analysis, and it never invents the decision. Editing an already finished memo remains a job for A1 Copy Editing.

**Try:**

> `/a1-decision-memo`
>
> Turn these launch notes, finance comments, and open risks into a memo for the COO who must approve or postpone the rollout.

Read the [A1 Decision Memo guide](./docs/skills/a1-decision-memo.md).

</details>

<details>
<summary><strong>A1 Promo Page — build one evidence-led page around one action</strong></summary>

<br>

A1 Promo Page creates a content blueprint or finished copy for one landing, product, service, course, event, or signup page. It moves from the audience's situation to the offer, proof, fit, objections, terms, and one primary action, with content requirements for useful visuals and artifacts when needed.

The skill can formulate a page-level value proposition from supplied facts. It does not invent product strategy, pricing, testimonials, proof, urgency, or scarcity.

**Try:**

> `/a1-promo-page`
>
> Create the page copy for this B2B service using the attached offer brief, customer evidence, price, and implementation terms.

Read the [A1 Promo Page guide](./docs/skills/a1-promo-page.md).

</details>

<details>
<summary><strong>A1 Press Release — make routine news accurate and easy to extract</strong></summary>

<br>

A1 Press Release drafts a new announcement for a routine launch, opening, partnership, program, event, research publication, milestone, or customer-relevant change. It returns distribution-ready copy only when critical inputs are confirmed; otherwise it returns a clearly marked working draft with verification gaps outside authoritative prose.

It does not invent or attribute quotations. Crisis, emergency, legal-response, regulatory, earnings, securities, and investor-relations statements are explicitly outside its scope.

**Try:**

> `/a1-press-release`
>
> Draft a press release from these launch facts. Mark it as working or distribution-ready and put anything that still needs verification outside authoritative copy.

Read the [A1 Press Release guide](./docs/skills/a1-press-release.md).
...
- **A1 Editorial:** `/a1-editorial:a1-copy-editing`, its Russian alias `/a1-editorial:a1-redaktura`, `/a1-editorial:a1-article-writing`, `/a1-editorial:a1-decision-memo`, `/a1-editorial:a1-promo-page`, `/a1-editorial:a1-press-release`, and `/a1-editorial:a1-humanize`
...
Update the ten capabilities and the Russian command alias:
