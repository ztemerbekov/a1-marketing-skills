...
require_text "README.md" "### Marketing Context" "README.md must explain the Marketing Context skill in user-facing language"
require_text "README.md" "### Editor" "README.md must explain the Editor skill in user-facing language"
require_text "README.md" "### Editor in Chief" "README.md must explain the Editor in Chief skill in user-facing language"
require_text "README.ru.md" "### Маркетинговый контекст" "README.ru.md must explain the Marketing Context skill in Russian"
require_text "README.ru.md" "### Редактор" "README.ru.md must explain the Editor skill in Russian"
require_text "README.ru.md" "### Шеф-редактор" "README.ru.md must explain the Editor in Chief skill in Russian"
