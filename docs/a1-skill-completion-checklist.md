...
- [ ] Judge every case against Must change, Must preserve, Forbidden, and output-contract criteria.
...
- [ ] Move the work to `ready-for-human` only after the verdict accurately represents the evidence.
