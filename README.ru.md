...
| `a1-editor-in-chief` | Нужно определить читателя, цель, канал, ограничения или редакционную стратегию | Проходит hard gate, создает Editor Brief и передает выбранную операцию в `a1-editor` |
