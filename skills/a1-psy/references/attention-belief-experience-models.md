# Attention, belief, and experience-model cards

These are diagnosis tools, not adjacent labels for any memorable message, stable belief, pleasant screen, or difficult copy. The [evidence ledger](evidence-ledger.md) is the canonical owner of research grades, sources, and evidence limitations.
...
- **Useful test:** randomize truthful frequency or creative rotation while holding offer and audience constant; measure familiarity and attitude separately from the desired business outcome, plus irritation, hiding, and opt-out. No dose-linked change in liking after separating recognition/familiarity weakens the hypothesis.
- **Applicability limit:** recommend neither indefinite frequency nor a universal dose; examine nonlinear dose and wear-out.
...
- **Useful test:** compare equally accurate evidence displays that change retrieval cues or the ease of recalling examples; measure perceived probability/risk, comprehension, calibration, and downstream choice. No judgment shift weakens the hypothesis.
- **Applicability limit:** preserve factual base and separate accessible content from the subjective experience of ease.
...
- **Useful test:** give balanced, equally understandable evidence and measure selection, search requests, interpretation, confidence, and calibration. A symmetric pattern or absence of a prior belief weakens the relevant submechanism.
- **Applicability limit:** name the submechanism being tested; never use the umbrella label as a verdict on users.
...
- **Useful test:** compare equally truthful, equally complete variants that vary one fluency cue; measure reading/comprehension, reported ease, target judgment, and calibration. A change in ease without the target judgment—or a reversal under a different attribution—weakens the proposed path.
- **Applicability limit:** do not optimize perceptual ease at the cost of legibility, disclosure, or comprehension.
...
- **Useful test:** hold factual information and disclosure constant while varying a transparent affective cue; measure affect, risk/benefit judgment, comprehension, trust, and later satisfaction. No affect–judgment relation weakens the hypothesis.
- **Applicability limit:** avoid using anxiety, vulnerability, or incidental mood as a covert lever.
...
- **Useful test:** improve a real end-state or pain point while holding the episode's core value constant; measure episode recall/evaluation, completion, complaints, and the business outcome separately. No change in retrospective episode evaluation weakens the mechanism; if experience changes without behavior, do not claim a business transfer.
- **Applicability limit:** specify the outcome and horizon; do not infer purchase, retention, or a universal duration effect from retrospective judgments.
...
- **Useful test:** record expert predictions before novice testing; compare prediction error with novice task time, completion, comprehension, support contacts, and frustration. Accurate expert prediction weakens this explanation.
- **Applicability limit:** diagnose a perspective-taking gap, not a personal defect in experts or users.
