# humanize-patterns-001 — English AI-Pattern Cluster

- ID: `humanize-patterns-001`
- Operation: `Humanize`
- Risk: A cluster of AI patterns survives or the rewrite invents specificity.
- Scope Scenario: `In scope`

## User Instruction

```text
Humanize this copy. Return only the final rewrite.
```
...
- [ ] Preserve `Review Hub`, marketplace teams, and review management.

## Forbidden

- [ ] Do not add features, metrics, automation, outcomes, a CTA, proof, drafts, audit bullets, or headings.
