...
Use the language of the user's current instruction for the map, questions, recommendations, explanations, and summaries. Preserve supplied product names, quotations, URLs, metrics, and explicit terms. When continuing a map, preserve its existing language unless the user asks to change it.
