...
Node.js 22, `npm`, and `npx` are available. Global and current-project installations are active. Command execution and both scopes are intercepted by a fixture.
