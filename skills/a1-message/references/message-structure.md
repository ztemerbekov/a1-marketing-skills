...
Choose optional blocks from the recipient's likely questions rather than applying a mandatory template. Include only the blocks that help the recipient understand, decide, act, or reply:
...
A fully assembled message should let the recipient answer, decide, act, or acknowledge without preventable follow-up. If a missing fact makes that impossible, use the blocking rule in [`source-policy.md`](source-policy.md) rather than choosing a material meaning or decision.
