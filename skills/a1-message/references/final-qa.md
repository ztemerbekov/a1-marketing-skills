...
- [ ] Every substantive statement traces to the current instruction, selected material, clearly applicable earlier conversation fact, or the first eligible Marketing Context source.
- [ ] Names, dates, amounts, counts, event names, dependencies, and causal claims remain accurate.
