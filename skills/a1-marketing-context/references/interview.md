...
If the user stops before any confirmed answer was supplied, traverse the empty no-write path and briefly confirm that the session stopped and no marketing context was created because no confirmed answers were saved. Do not create a directory or file, link a nonexistent context, list changed sections, describe the result as incomplete, or ask another question.
